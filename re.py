...
if ask == "what is your name":
    ...
    print("I have made by Migara Bhanu Weragoda, Who is a student of Ananada College Colombo 10")
    os.system("python re.py")
elif ask == "who designed you":
    print("I have designed by Migara Bhanu Weragoda, Who is a student of Ananda College Colombo 10")
    os.system("python re.py")
